...
export const baseModuleList: IBaseModule[] = [
    { 
      name : "facebook",
      html:`
      <div> 
...
export const addModule =(editor:any,name:String , pos_x:any, pos_y:any)=>{
    const module = baseModuleList.find(a=>a.name == name);
    if(!module) return;
    editor.addNode(name, 0,  1, pos_x, pos_y, name, {}, module?.html );
}
